...
const content = [
  {
    ...
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white p-1">
        <Image src="/images/our-story.jpeg" width={300} height={300} className="h-full w-full object-cover" alt="Our story" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full flex items-center justify-center text-white p-1">
        <Image src="/images/core-values.jpeg" width={300} height={300} className="h-full w-full object-cover" alt="Core values" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] flex items-center justify-center text-white p-1">
        <Image src="/images/our-services.jpeg" width={300} height={300} className="h-full w-full object-cover" alt="Our services" />
      </div>
    ),
  },
];
